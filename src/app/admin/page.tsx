  ...
  const cards = [
    {
      ...
      icon: ICONS.members,
      title: "Members",
      description: "Add and remove members, set admin access.",
    ...
    },
    {
      ...
      description: "Add or update senior profiles — their timeline, destination, and advice.",
    ...
    },
    {
      ...
      description: "Add people to the alumni map and directory.",
    ...
    },
    {
      ...
      description: "Upload guides, interview prep, and resources by career track.",
